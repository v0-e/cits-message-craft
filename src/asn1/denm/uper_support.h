 ...
 */
int per_long_range_rebase(long long, intmax_t lb, intmax_t ub, unsigned long long *output);
...
int per_long_range_unrebase(unsigned long long inp, intmax_t lb, intmax_t ub, long long *outp);

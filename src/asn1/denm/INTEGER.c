...
INTEGER__dump(const asn_TYPE_descriptor_t *td, const INTEGER_t *st, asn_app_consume_bytes_f *cb, void *app_key, int plainOrXER) {
	...
	/* Output in the long long xx:yy:zz... format */
...
INTEGER_map_value2enum(const asn_INTEGER_specifics_t *specs, long long value) {
...
asn_imax2INTEGER(INTEGER_t *st, intmax_t value) {
	...
	buf = (uint8_t *)(long long *)MALLOC(sizeof(value));
	if(!buf) return -1;
...
int
asn_INTEGER2long(const INTEGER_t *iptr, long long *l) {
    intmax_t v;
...
int
asn_INTEGER2ulong(const INTEGER_t *iptr, unsigned long long *l) {
    uintmax_t v;
...
enum asn_strtox_result_e
asn_strtoul_lim(const char *str, const char **end, unsigned long long *ulp) {
    uintmax_t value;

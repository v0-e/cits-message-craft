...
static asn_TYPE_member_t asn_MBR_class_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Class, choice.vehicle),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Class, choice.person),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Class, choice.animal),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Class, choice.other),
...
static asn_CHOICE_specifics_t asn_SPC_class_specs_3 = {
	...
	offsetof(struct Class, present),
	sizeof(((struct Class *)0)->present),
